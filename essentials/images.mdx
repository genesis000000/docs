...
- The depth-sensing camera system should have a wide field of view to capture the user's full body and surroundings.
...
Have a high frame rate (e.g., 60 FPS or higher) for smooth motion capture and minimal latency.
Resolution should be at least 1080p or higher for capturing fine details and textures. (Though this is not a priority now)
Examples: Manufacturers from like Sony or OmniVision
...
Examples: Qualcomm Snapdragon or Samsung Exynos series that are designed for mobile devices

Edit: We can explore using embedded SoCs specifically designed for computer vision and AI applications, such as those from Jetson series or Google’s Coral.
...
The watch will need to transmit a significant amount of data (depth, color, and potentially processed 3D data) to the AR glasses and central AR system in real-time.
High bandwidth options like Wi-Fi 6 or 5G can work I believe but it  depends
...
We need an efficient cooling system, such as heat pipes or liquid cooling
