...
description: 'While wearing your glasses, when you move, the hologram moves'
---

## A System Put in Place

**Central AR System:**
- Receives data from both the AR glasses and the watch.
- Processes environmental data from the watch.
- Manages synchronization between devices.

**Environment Capture in the Smartwatch:**

- The user initiates the environment capture process by clicking on the smartwatch screen.

- The  sensors and cameras on the smartwatch capture the real-life environment, including objects, lighting conditions, and any others types.

- Incorporating “blurring” on anything that is not captured properly

**Data Transmission to the AR Glasses:**

- The smartwatch captures the environment data that is processed by the onboard processor.

- Once processed, the data is transmitted to the AR glasses via a wireless communication like Bluetooth.
